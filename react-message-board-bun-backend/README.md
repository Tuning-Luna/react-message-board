...
**Tips：这是快速开发的后端项目，虽然也可以使用，但是不如 Java 后端规范，也没有数据库支持和邮箱支持，完整版请看[react-message-board-java-backend](../react-message-board-java-backend)**
